        ...
        <section className="flex flex-col gap-16 lg:mx-auto lg:max-w-[1440px] pb-30">
            ...
            <section className="px-4 pb-4 md:px-14 flex flex-col gap-6">
                ...
                <div className="flex flex-row gap-2">
                    ...
                    <div>
                        <h1 className="text-[19px] md:text-[21px] font-medium tracking-[-1.14px] leading-[100%] md:leading-[120%] md:tracking-[-1.26px]">Filters</h1>
                    </div>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <h1 className="text-[15px] md:text-[16px] leading-[150%] tracking-[-0.9px]">By Categories</h1>
                ...
                <div className="flex flex-col gap-3">
                    <h1 className="text-[15px] md:text-[16px] leading-[150%] tracking-[-0.9px]">By Location</h1>
